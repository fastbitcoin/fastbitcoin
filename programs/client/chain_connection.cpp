...
const chain_message_type trx_err_message::type   = chain_message_type::trx_err_msg;
  ...
  namespace detail
  {
     class chain_connection_impl
     {
        public:
          ...
          fbtc::blockchain::block_id_type   _last_block_id;
          fbtc::blockchain::chain_database* chain;
  ...
  void chain_connection::set_last_block_id( const fbtc::blockchain::block_id_type& id )
  {
     my->_last_block_id = id;
  }
  fbtc::blockchain::block_id_type chain_connection::get_last_block_id()const
  {
...
#define MAIL_PACKED_MESSAGE_HEADER sizeof(message_header)
      ...
      my->exec_sync_loop_complete = fc::async( [=]() 
      {
          while( !my->exec_sync_loop_complete.canceled() )
          {
             try {
                ...
                if( my->_last_block_id != fbtc::blockchain::block_id_type() )
  ...
  void chain_connection::set_database( fbtc::blockchain::chain_database* db )
  {
     my->chain = db;
  }
