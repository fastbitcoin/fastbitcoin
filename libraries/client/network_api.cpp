...
fbtc::blockchain::transaction_id_type detail::client_impl::network_broadcast_transaction(const fbtc::blockchain::signed_transaction& transaction_to_broadcast)
{
...
std::vector<fc::variant_object> detail::client_impl::network_get_peer_info( bool hide_firewalled_nodes )const
{
   ...
   std::vector<fbtc::net::peer_status> peer_statuses = _p2p_node->get_connected_peers();
   for (const fbtc::net::peer_status& peer_status : peer_statuses)
...
void detail::client_impl::network_set_allowed_peers(const vector<fbtc::net::node_id_t>& allowed_peers)
{
...
fbtc::net::message_propagation_data detail::client_impl::network_get_transaction_propagation_data(const transaction_id_type& transaction_id)
{
...
fbtc::net::message_propagation_data detail::client_impl::network_get_block_propagation_data(const block_id_type& block_id)
{
...
vector<fbtc::net::potential_peer_record> client_impl::network_list_potential_peers()const
{
