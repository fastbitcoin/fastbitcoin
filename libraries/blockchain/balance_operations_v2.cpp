...
{ try {
   if( eval_state.pending_state()->get_head_block_num() < FBTC_V0_4_13_FORK_BLOCK_NUM )
   ...
   if( asset_rec->is_market_issued() )
   {
      ...
      if( eval_state.pending_state()->get_head_block_num() < FBTC_V0_4_21_FORK_BLOCK_NUM )
      {
...
{ try {
    ...
    if( eval_state.pending_state()->get_head_block_num() >= FBTC_V0_5_0_FORK_BLOCK_NUM )
    {
    ...
    if( eval_state.pending_state()->get_head_block_num() >= FBTC_V0_6_0_FORK_BLOCK_NUM )
    {
