...
#include <fbtc/blockchain/graphene.hpp>
...
struct snapshot_asset
{
    ...
    map<address, snapshot_debt> defbtc;
};
...
FC_REFLECT( fbtc::blockchain::snapshot_summary, (num_balance_owners)(num_asset_balances)(num_vesting_balances)
...
FC_REFLECT( fbtc::blockchain::snapshot_vesting_balance, (start_time)(duration_seconds)(original_balance)(current_balance) )
FC_REFLECT( fbtc::blockchain::snapshot_balance, (assets)(vesting) )
FC_REFLECT( fbtc::blockchain::snapshot_account, (id)(timestamp)(owner_key)(active_key)(signing_key)(daily_pay) )
FC_REFLECT( fbtc::blockchain::snapshot_debt, (collateral)(debt) )
FC_REFLECT( fbtc::blockchain::snapshot_asset, (id)(owner)(description)(precision)(max_supply)(collected_fees)(defbtc) )
FC_REFLECT( fbtc::blockchain::snapshot_state, (head_block)(max_core_supply)(summary)(balances)(accounts)(assets) )
