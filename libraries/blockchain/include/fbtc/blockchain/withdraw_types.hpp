...
namespace fbtc { namespace blockchain {
   ...
   struct memo_data
   {
       ...
       */
      fc::array<char,FBTC_BLOCKCHAIN_MAX_MEMO_SIZE>     message;
   ...
   struct extended_memo_data
   {
      ...
      fc::array<char,FBTC_BLOCKCHAIN_MAX_MEMO_SIZE>      message;
      fc::enum_type<uint8_t,memo_flags_enum>            memo_flags = from_memo;
      fc::array<char,FBTC_BLOCKCHAIN_EXTENDED_MEMO_SIZE> extra_message;
   };
   ...
   struct withdraw_p2sh_multisig
   {
	   withdraw_p2sh_multisig(const address owner_arg = address())
		   :owner(owner_arg) {}
	   static const uint8_t    type;
...
namespace fc {
   void to_variant( const fbtc::blockchain::withdraw_condition& var,  variant& vo );
   void from_variant( const variant& var,  fbtc::blockchain::withdraw_condition& vo );
   void to_variant( const fbtc::blockchain::memo_data& var,  variant& vo );
   void from_variant( const variant& var,  fbtc::blockchain::memo_data& vo );
}

FC_REFLECT_ENUM( fbtc::blockchain::withdraw_condition_types,
        (withdraw_null_type)
...
FC_REFLECT( fbtc::blockchain::withdraw_condition,
        (asset_id)
        (slate_id)
        (type)
        (data)
        )
FC_REFLECT( fbtc::blockchain::titan_memo,
        (one_time_key)
        (encrypted_memo_data)
        )
FC_REFLECT_ENUM( fbtc::blockchain::memo_flags_enum,
        (from_memo)
        (to_memo)
        )
FC_REFLECT( fbtc::blockchain::memo_data,
        (from)
        (from_signature)
        (message)
        (memo_flags)
...
FC_REFLECT( fbtc::blockchain::extended_memo_data,
        (from)
        (from_signature)
        (message)
        (memo_flags)
...
FC_REFLECT_DERIVED( fbtc::blockchain::memo_status,
        (fbtc::blockchain::memo_data),
        (has_valid_signature)
        (owner_private_key)
        )
FC_REFLECT( fbtc::blockchain::withdraw_with_signature,
        (owner)
        (memo)
        )
FC_REFLECT( fbtc::blockchain::withdraw_vesting,
        (owner)
        (start_time)
        (duration)
        (original_balance)
        )
FC_REFLECT( fbtc::blockchain::withdraw_with_multisig,
        (required)
        (owners)
        (memo)
        )
FC_REFLECT( fbtc::blockchain::withdraw_with_escrow,
        (sender)
        (receiver)
        (escrow)
        (agreement_digest)
...
FC_REFLECT(fbtc::blockchain::withdraw_p2sh_multisig,
		(owner)
		)
