...
FC_REFLECT( fbtc::blockchain::status_index, (quote_id)(base_id) )
FC_REFLECT( fbtc::blockchain::status_record, (index)(current_feed_price)(last_valid_feed_price)(last_error)(ask_depth)(bid_depth)(center_price) )
FC_REFLECT_DERIVED( fbtc::blockchain::string_status_record, (fbtc::blockchain::status_record), (current_feed_price)(last_valid_feed_price) )
