...
FC_REFLECT( fbtc::blockchain::register_account_operation, (name)(public_data)(owner_key)(active_key)(delegate_pay_rate)(meta_data) )
FC_REFLECT( fbtc::blockchain::update_account_operation, (account_id)(public_data)(active_key)(delegate_pay_rate) )
FC_REFLECT( fbtc::blockchain::withdraw_pay_operation, (amount)(account_id) )
FC_REFLECT( fbtc::blockchain::update_signing_key_operation, (account_id)(signing_key) )
