...
FC_REFLECT( fbtc::blockchain::create_asset_operation,
        (symbol)
        (name)
        (description)
        (public_data)
...
FC_REFLECT( fbtc::blockchain::issue_asset_operation,
        (amount)
        )
FC_REFLECT( fbtc::blockchain::asset_update_properties_operation,
        (asset_id)
        (issuer_id)
        (name)
        (description)
...
FC_REFLECT( fbtc::blockchain::asset_update_permissions_operation,
        (asset_id)
        (authority)
        (authority_flag_permissions)
        (active_flags)
        )
FC_REFLECT( fbtc::blockchain::asset_update_whitelist_operation,
        (asset_id)
        (account_ids)
        )
