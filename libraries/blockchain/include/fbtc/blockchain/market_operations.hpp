...
FC_REFLECT_DERIVED( fbtc::blockchain::market_index_key_ext, (fbtc::blockchain::market_index_key), (limit_price) )
FC_REFLECT( fbtc::blockchain::bid_operation, (amount)(bid_index) )
FC_REFLECT( fbtc::blockchain::ask_operation, (amount)(ask_index) )
FC_REFLECT( fbtc::blockchain::short_operation, (amount)(short_index) )
FC_REFLECT( fbtc::blockchain::short_operation_v1, (amount)(short_index) )
FC_REFLECT( fbtc::blockchain::cover_operation, (amount)(cover_index)(reserved) )
FC_REFLECT( fbtc::blockchain::add_collateral_operation, (amount)(cover_index) )
