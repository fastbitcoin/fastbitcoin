...
FC_REFLECT_ENUM( fbtc::blockchain::account_key_type,
                 (owner_key)
                 (active_key)
                 (signing_key)
                 )
FC_REFLECT_ENUM( fbtc::blockchain::account_type,
                 (titan_account)
                 (public_account)
                 (multisig_account)
                 )
FC_REFLECT( fbtc::blockchain::multisig_meta_info,
            (required)
            (owners)
            )
FC_REFLECT( fbtc::blockchain::account_meta_info,
            (type)
            (data)
            )
FC_REFLECT( fbtc::blockchain::delegate_stats,
            (votes_for)
            (pay_rate)
            (signing_key_history)
...
FC_REFLECT( fbtc::blockchain::vote_del,
            (votes)
            (delegate_id)
            )
FC_REFLECT( fbtc::blockchain::account_record,
            (id)
            (name)
            (public_data)
            (owner_key)
