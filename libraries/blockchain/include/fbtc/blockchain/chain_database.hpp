...
#include <fbtc/blockchain/delegate_config.hpp>
...
namespace fbtc { namespace blockchain {
   ...
   class chain_database : public chain_interface, public std::enable_shared_from_this<chain_database>
   {
      public:
		 ...
		 int32_t									get_pending_transactions_size()const;
         ...
         vector<market_order>               get_market_covers( const string& quote_symbol,
                                                               const string& base_symbol = FBTC_BLOCKCHAIN_SYMBOL,
                                                               uint32_t limit = uint32_t(-1) )const;
         ...
         unordered_map<asset_id_type, share_type> calculate_defbtc( bool include_interest )const;
...
FC_REFLECT( fbtc::blockchain::block_fork_data, (next_blocks)(is_linked)(is_valid)(invalid_reason)(is_included)(is_known) )
FC_REFLECT( fbtc::blockchain::fork_record, (block_id)(signing_delegate)(transaction_count)(latency)(size)(timestamp)(is_valid)(invalid_reason)(is_current_fork) )
