...
FC_REFLECT( fbtc::blockchain::immutable_chain_parameters,
   (min_committee_member_count)
   (min_witness_count)
)

FC_REFLECT(fbtc::blockchain::genesis_state_type::initial_account_type, (id)(name)(owner_key)(active_key)(is_lifetime_member)(is_prefixed))

FC_REFLECT(fbtc::blockchain::genesis_state_type::initial_asset_type,
           (id)(symbol)(issuer_name)(description)(precision)(max_supply)(accumulated_fees)(is_bitasset)(collateral_records))

FC_REFLECT(fbtc::blockchain::genesis_state_type::initial_asset_type::initial_collateral_position,
           (owner)(collateral)(debt))

FC_REFLECT(fbtc::blockchain::genesis_state_type::initial_balance_type,
           (owner)(asset_symbol)(amount))

FC_REFLECT(fbtc::blockchain::genesis_state_type::initial_vesting_balance_type,
           (owner)(asset_symbol)(amount)(begin_timestamp)(vesting_duration_seconds)(begin_balance))

FC_REFLECT(fbtc::blockchain::genesis_state_type::initial_witness_type, (owner_name)(block_signing_key))

FC_REFLECT(fbtc::blockchain::genesis_state_type::initial_committee_member_type, (owner_name))

FC_REFLECT(fbtc::blockchain::genesis_state_type::initial_worker_type, (owner_name)(daily_pay))

FC_REFLECT(fbtc::blockchain::genesis_state_type,
