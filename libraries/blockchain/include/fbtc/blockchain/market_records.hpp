...
#include <fbtc/blockchain/asset.hpp>
...
FC_REFLECT_ENUM( fbtc::blockchain::order_type_enum,
                 (null_order)
                 (bid_order)
                 (ask_order)
                 (short_order)
...
FC_REFLECT_ENUM( fbtc::blockchain::market_history_key::time_granularity_enum, (each_block)(each_hour)(each_day) )
FC_REFLECT( fbtc::blockchain::market_index_key, (order_price)(owner) )
FC_REFLECT( fbtc::blockchain::market_history_record, (highest_bid)(lowest_ask)(opening_price)(closing_price)(base_volume)(quote_volume) )
FC_REFLECT( fbtc::blockchain::market_history_key, (quote_id)(base_id)(granularity)(timestamp) )
FC_REFLECT( fbtc::blockchain::market_history_point, (timestamp)(highest_bid)(lowest_ask)(opening_price)(closing_price)(base_volume)(quote_volume) )
FC_REFLECT( fbtc::blockchain::order_record, (balance)(limit_price)(last_update) )
FC_REFLECT( fbtc::blockchain::collateral_record, (collateral_balance)(payoff_balance)(interest_rate)(expiration) )
FC_REFLECT( fbtc::blockchain::market_order, (type)(market_index)(state)(collateral)(interest_rate)(expiration) )
FC_REFLECT_TYPENAME( std::vector<fbtc::blockchain::market_transaction> )
FC_REFLECT_TYPENAME( fbtc::blockchain::market_history_key::time_granularity_enum ) // http://en.wikipedia.org/wiki/Voodoo_programminqg
FC_REFLECT( fbtc::blockchain::market_transaction,
            (bid_type)
            (ask_type)
            (bid_index)
            (ask_index)
...
FC_REFLECT_DERIVED( fbtc::blockchain::order_history_record, (fbtc::blockchain::market_transaction), (timestamp) )
