...
struct withdraw_operation
{
	...
	withdraw_operation(const balance_id_type& id, share_type amount_arg,std::vector<char> claim_input_data)
...
FC_REFLECT( fbtc::blockchain::withdraw_operation, (balance_id)(amount)(claim_input_data) )
FC_REFLECT( fbtc::blockchain::deposit_operation, (amount)(condition) )
FC_REFLECT( fbtc::blockchain::burn_operation, (amount)(account_id)(message)(message_signature) )
FC_REFLECT( fbtc::blockchain::release_escrow_operation, (escrow_id)(released_by)(amount_to_receiver)(amount_to_sender) )
FC_REFLECT( fbtc::blockchain::update_balance_vote_operation, (balance_id)(new_restricted_owner)(new_slate) )
FC_REFLECT( fbtc::blockchain::limit_fee_operation, (max_fee) )
