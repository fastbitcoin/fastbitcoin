...
FC_REFLECT( fbtc::blockchain::block_header,
            (previous)(block_num)(timestamp)(transaction_digest)(next_secret_hash)(previous_secret) )
FC_REFLECT_DERIVED( fbtc::blockchain::signed_block_header, (fbtc::blockchain::block_header), (delegate_signature) )
FC_REFLECT_DERIVED( fbtc::blockchain::full_block, (fbtc::blockchain::signed_block_header), (user_transactions) )
FC_REFLECT_DERIVED( fbtc::blockchain::digest_block, (fbtc::blockchain::signed_block_header), (user_transaction_ids) )
