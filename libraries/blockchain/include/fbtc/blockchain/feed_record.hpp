...
FC_REFLECT( fbtc::blockchain::feed_index, (quote_id)(delegate_id) )
FC_REFLECT( fbtc::blockchain::feed_record, (index)(value)(last_update) )
FC_REFLECT( fbtc::blockchain::feed_entry, (delegate_name)(price)(last_update)(asset_symbol)(median_price) );
