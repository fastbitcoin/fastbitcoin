...
void cover_operation::evaluate_v4( transaction_evaluation_state& eval_state )const
{
   ...
   const auto start_time = current_cover->expiration - fc::seconds( FBTC_BLOCKCHAIN_MAX_SHORT_PERIOD_SEC );
   ...
   if( eval_state.pending_state()->get_head_block_num() < FBTC_V0_4_23_FORK_BLOCK_NUM )
   {
