...
namespace fc
{
    void to_variant( const fbtc::blockchain::public_key_type& var,  fc::variant& vo )
    {
        vo = std::string(var);
    }

    void from_variant( const fc::variant& var,  fbtc::blockchain::public_key_type& vo )
    {
        vo = fbtc::blockchain::public_key_type( var.as_string() );
    }
} // fc
