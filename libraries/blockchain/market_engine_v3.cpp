...
#define FBTC_BLOCKCHAIN_INITIAL_SHARES (FBTC_BLOCKCHAIN_MAX_SHARES/5)
#define FBTC_BLOCKCHAIN_MARKET_DEPTH_REQUIREMENT_V3 (FBTC_BLOCKCHAIN_INITIAL_SHARES/4000)
      ...
      bool market_engine_v3::execute( asset_id_type quote_id, asset_id_type base_id, const fc::time_point_sec timestamp )
      {
         try {
            ...
            base_asset->collected_fees += mtrx.base_fees.amount;
             ...
             {
                if( market_stat->ask_depth < FBTC_BLOCKCHAIN_MARKET_DEPTH_REQUIREMENT_V3
                    || market_stat->bid_depth < FBTC_BLOCKCHAIN_MARKET_DEPTH_REQUIREMENT_V3 )
                {
                  ...
                  FC_CAPTURE_AND_THROW( insufficient_depth, (reason)(market_stat)(FBTC_BLOCKCHAIN_MARKET_DEPTH_REQUIREMENT_V3) );
                }
             }
...
#undef FBTC_BLOCKCHAIN_MARKET_DEPTH_REQUIREMENT_V3
