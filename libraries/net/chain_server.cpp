...
#include <fbtc/net/chain_server_commands.hpp>
    ...
    namespace detail {
        class chain_server_impl {
          public:
            ...
            std::shared_ptr<fbtc::blockchain::chain_database> _chain_db;
            ...
            chain_server_impl(std::shared_ptr<fbtc::blockchain::chain_database> chain_ptr, uint16_t port)
              : _chain_db(chain_ptr),
...
fbtc::net::chain_server::chain_server(std::shared_ptr<fbtc::blockchain::chain_database> chain_ptr, uint16_t port)
...
uint16_t fbtc::net::chain_server::get_listening_port()
{
