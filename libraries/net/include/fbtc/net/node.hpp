  ...
  struct message_propagation_data
  {
   ...
   class node_delegate
   {
      public:
          ...
          */
         virtual std::vector<item_hash_t> get_blockchain_synopsis(uint32_t item_type, const fbtc::net::item_hash_t& reference_point = fbtc::net::item_hash_t(), uint32_t number_of_blocks_after_reference_point = 0) = 0;
...
FC_REFLECT(fbtc::net::message_propagation_data, (received_time)(validated_time)(originating_peer));
