...
namespace fbtc { namespace net {
   ...
   class chain_connection : public std::enable_shared_from_this<chain_connection>
   {
      public:
        ...
        fbtc::blockchain::block_id_type get_last_block_id()const;
        void                           set_last_block_id( const fbtc::blockchain::block_id_type& t );

        void exec_sync_loop();
        void set_database( fbtc::blockchain::chain_database*  );
