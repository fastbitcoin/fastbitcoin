...
#include <fbtc/net/message_oriented_connection.hpp>
...
namespace fbtc { namespace net
  {
    ...
    public:
      ...
      fc::optional<std::string> fbtcshares_git_revision_sha;
      fc::optional<fc::time_point_sec> fbtcshares_git_revision_unix_timestamp;
...
FC_REFLECT_ENUM(fbtc::net::peer_connection::our_connection_state, (disconnected)
                                                                 (just_connected)
                                                                 (connection_accepted)
                                                                 (connection_rejected))
FC_REFLECT_ENUM(fbtc::net::peer_connection::their_connection_state, (disconnected)
                                                                   (just_connected)
                                                                   (connection_accepted)
                                                                   (connection_rejected))
FC_REFLECT_ENUM(fbtc::net::peer_connection::connection_negotiation_status, (disconnected)
                                                                          (connecting)
                                                                          (connected)
                                                                          (accepting)
                                                                          (accepted)
