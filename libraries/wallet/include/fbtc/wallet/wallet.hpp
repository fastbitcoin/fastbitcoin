...
#include <fbtc/blockchain/transaction_creation_state.hpp>
...
namespace fbtc { namespace wallet {
   ...
   class wallet
   {
      public:
		 ...
		 wallet_transaction_record transfer_asset_to_genesis_multisig_address(
			 const asset& amount,
			 const string& from_account_name,
			 const string& generic_recipient,
			 const string& memo,
         ...
         wallet_transaction_record register_account(
                 ...
                 fbtc::blockchain::account_type new_account_type,
                 bool sign
                 );
