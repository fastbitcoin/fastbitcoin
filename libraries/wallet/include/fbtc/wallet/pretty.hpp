...
FC_REFLECT( fbtc::wallet::public_key_summary, (hex)(native_pubkey)(native_address)(pts_normal_address)(pts_compressed_address)(btc_normal_address)(btc_compressed_address) )

FC_REFLECT( fbtc::wallet::pretty_ledger_entry,
            (from_account)
            (to_account)
            (amount)
            (memo)
...
FC_REFLECT( fbtc::wallet::pretty_transaction,
            (is_virtual)
            (is_confirmed)
            (is_market)
            (is_market_cancel)
...
FC_REFLECT( fbtc::wallet::pretty_vesting_balance,
        (balance_id)
        (sharedrop_address)
        (start_time)
        (duration)
...
FC_REFLECT( fbtc::wallet::escrow_summary,
