...
FC_REFLECT_ENUM(fbtc::api::method_prerequisites, (no_prerequisites)(json_authenticated)(wallet_open)(wallet_unlocked)(connected_to_network))
FC_REFLECT_ENUM( fbtc::api::parameter_classification, (required_positional)(required_positional_hidden)(optional_positional)(optional_named) )
FC_REFLECT( fbtc::api::parameter_data, (name)(type)(classification)(default_value) )
FC_REFLECT( fbtc::api::method_data, (name)(description)(return_type)(parameters)(prerequisites)(detailed_description)(aliases)(cached) )
